...
const submitWishlist = (e) =>{
	...
	axios.post('http://127.0.0.1:8000/api/addtowishlist', data)
    .then((resp) => {
        try {
            const data = resp.data;
            console.log(data);
    ...
    <React.Fragment>
		<Header/>
										...
										<div class="product-gallery">
											<div class="quickview-slider-active">
												<div class="single-slider">
													<img src={`http://localhost:8000/product_upload/${product.img}`} alt="#" style={{width:"380px",height:"290px",marginTop:"40px",marginLeft:"40px"}}/>
												</div>
												<div class="single-slider">
												<img src={`http://localhost:8000/product_upload/${product.img}`} alt="#" style={{width:"380px",height:"290px",marginTop:"40px",marginLeft:"40px"}}/>
            ...
            <input type="number" value={pqty} onChange={handleQuantityChange} /> */}
										...
										<button class="btn btn-outline-success mt-2 btn-long cart" onClick={submitWishlist}>Wishlist</button>
